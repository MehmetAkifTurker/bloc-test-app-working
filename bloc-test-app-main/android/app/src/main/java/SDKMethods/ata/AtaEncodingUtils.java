...
public class AtaEncodingUtils {
    ...
    static {
        ...
        // NOTE: '@' (ASCII 64) has NO 6-bit representation (N/A in Appendix B Table 25).
        // 000000 is the NUL delimiter, not '@'. Do NOT add '@' to this map.
    ...
    public static final int TEI_LOT_MIN = 1;      // Lot/Enterprise Lot Number: 1-15 chars
    ...
    public static String validateTeiLength(String tei, String value) {
        ...
        switch (teiUpper) {
            ...
            case "LOT":
            case "LTN":
                // ATA Spec 2000 Table 3: LOT/LTN share the same 1-15 range
