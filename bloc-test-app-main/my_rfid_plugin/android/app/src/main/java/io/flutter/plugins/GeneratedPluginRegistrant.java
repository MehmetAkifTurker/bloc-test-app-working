...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.my_rfid_plugin.RfidC72Plugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin my_rfid_plugin, com.example.my_rfid_plugin.RfidC72Plugin", e);
    }
  }
}
